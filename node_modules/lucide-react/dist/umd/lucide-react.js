...
(function (global, factory) {
  ...
  const Axe = createLucideIcon("axe", __iconNode$nJ);
  ...
  const BadgeQuestionMark = createLucideIcon("badge-question-mark", __iconNode$nt);
  ...
  const BadgeRussianRuble = createLucideIcon("badge-russian-ruble", __iconNode$ns);
  ...
  const Barrel = createLucideIcon("barrel", __iconNode$ne);
  ...
  const Baseline = createLucideIcon("baseline", __iconNode$nd);
  ...
  const BeanOff = createLucideIcon("bean-off", __iconNode$n2);
  ...
  const Bell = createLucideIcon("bell", __iconNode$mR);
  ...
  const BluetoothOff = createLucideIcon("bluetooth-off", __iconNode$mB);
  ...
  const BluetoothSearching = createLucideIcon("bluetooth-searching", __iconNode$mA);
  ...
  const BookUp = createLucideIcon("book-up", __iconNode$m9);
  ...
  const BookUser = createLucideIcon("book-user", __iconNode$m8);
  ...
  const BotOff = createLucideIcon("bot-off", __iconNode$l_);
  ...
  const Bot = createLucideIcon("bot", __iconNode$lZ);
  ...
  const Captions = createLucideIcon("captions", __iconNode$l1);
  ...
  const ChartNoAxesColumn = createLucideIcon("chart-no-axes-column", __iconNode$kx);
  ...
  const ChartNoAxesCombined = createLucideIcon("chart-no-axes-combined", __iconNode$kw);
  ...
  const Cigarette = createLucideIcon("cigarette", __iconNode$k4);
  ...
  const CircleQuestionMark = createLucideIcon("circle-question-mark", __iconNode$jw);
  ...
  const CircleStop = createLucideIcon("circle-stop", __iconNode$js);
  ...
  const Clock12 = createLucideIcon("clock-12", __iconNode$j6);
  ...
  const CornerLeftDown = createLucideIcon("corner-left-down", __iconNode$h_);
  ...
  const Fan = createLucideIcon("fan", __iconNode$gB);
  ...
  const FolderCheck = createLucideIcon("folder-check", __iconNode$f8);
  ...
  const FolderClock = createLucideIcon("folder-clock", __iconNode$f7);
  ...
  const FolderArchive = createLucideIcon("folder-archive", __iconNode$f6);
  ...
  const Import = createLucideIcon("import", __iconNode$cL);
  ...
  const Link2 = createLucideIcon("link-2", __iconNode$bT);
  ...
  const LogOut = createLucideIcon("log-out", __iconNode$bo);
  ...
  const Logs = createLucideIcon("logs", __iconNode$bn);
  ...
  const MapPinPlus = createLucideIcon("map-pin-plus", __iconNode$a$);
  ...
  const MonitorOff = createLucideIcon("monitor-off", __iconNode$a0);
  ...
  const NotepadText = createLucideIcon("notepad-text", __iconNode$9e);
  ...
  const Shield = createLucideIcon("shield", __iconNode$5u);
  ...
  const Signature = createLucideIcon("signature", __iconNode$5a);
